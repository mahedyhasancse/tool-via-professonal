...
export default function DiscountCalculator() {
    ...
    return (
        <ToolPageLayout title="Discount Calculator" description="Find the final price after applying any discount percentage." category="Calculators" categoryHref="/calculators" categoryIcon="🧮" icon="🏷️" badge="free">
