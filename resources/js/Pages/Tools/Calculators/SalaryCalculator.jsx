...
export default function SalaryCalculator() {
    ...
    return (
        <ToolPageLayout title="Salary Calculator" description="Convert salary between hourly, daily, weekly, monthly, and annual rates with tax." category="Calculators" categoryHref="/dashboard/calculators" categoryIcon="🧮" icon="💼" badge="free">
